...
function trouverPersonnel() {
  return client.searchAsync('ou=people,o=personnel,dc=cnam,dc=fr', { filter: '(&(uid=lelongj))', scope: 'sub', attributes: ['uid', 'givenname', 'lecnamnet-mail', 'codeservice', 'sn', 'casecourrier'] }).then(function (res) {
...
//# sourceMappingURL=0.4797e0b60bbb722bafed.hot-update.js.map