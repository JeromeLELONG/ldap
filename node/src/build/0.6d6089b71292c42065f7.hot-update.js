...
client.searchAsync('ou=people,o=personnel,dc=cnam,dc=fr', { filter: '(&(uid=lelongj))', scope: 'sub', attributes: ['uid', 'givenname'] }).then(function (res) {
...
//# sourceMappingURL=0.6d6089b71292c42065f7.hot-update.js.map