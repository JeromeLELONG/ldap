      ...
      if (error) {
        ...
        client.search('ou=people,o=personnel,dc=cnam,dc=fr', opts, function (error, search) {
          ...
          search.on('searchEntry', function (entry) {
            if (entry.object) {
              console.log('entry: %j ' + __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default()(entry.object));
            }
            return entry.object;
          });
...
//# sourceMappingURL=0.807e818b371a7ef3cf7f.hot-update.js.map