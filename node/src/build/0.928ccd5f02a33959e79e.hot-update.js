...
function trouverPersonnel() {
  return client.searchAsync('ou=people,o=personnel,dc=cnam,dc=fr', { filter: '(&(uid=lelongj))', scope: 'sub', attributes: ['uid', 'givenname', 'lecnamnet-mail', 'codeservice'] }).then(function (res) {
...
//# sourceMappingURL=0.928ccd5f02a33959e79e.hot-update.js.map